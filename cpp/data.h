...
#define msb(b) __builtin_clzll(b)
...
#define getPawnEval(turn, sq) (turn? pawnEvalTable[sq] : pawnEvalTable[64-sq])
#define getKnightEval(turn, sq) (turn? knightEvalTable[sq] : knightEvalTable[64-sq])
#define getBishopEval(turn, sq) (turn? bishopEvalTable[sq] : bishopEvalTable[64-sq])
#define getRookEval(turn, sq) (turn? rookEvalTable[sq] : rookEvalTable[64-sq])
#define getQueenEval(turn, sq) (turn? queenEvalTable[sq] : queenEvalTable[64-sq])
#define getKingEval(turn, sq) (turn? kingEvalTable[sq] : kingEvalTable[64-sq])

using namespace std;

//transposition table
map<array<uint64_t,7>, array<int,2>> boardEvalTable;
...
//evaluation data, simplified eval
...
void init_tables() {
    for (int p = 0; p < 6; p++) {
        for (int sq = 0; sq < 64; sq++) {
            ...
            mg_table[p+6][sq] = - mg_value[p] - mg_pesto_table[p][64-sq];
            eg_table[p+6][sq] = - eg_value[p] - eg_pesto_table[p][64-sq];
        }
    }
}
